...
function test_replace_can_focus_on_path {
    seed_incoming ./school/replace/incoming
    duplicate_and_adjust ./school/replace/incoming ./school/replace/actual
    local actual=$(cat ./school/replace/actual/import)
...
function test_replace_can_focus_on_variable {
    seed_incoming ./school/replace/incoming
    duplicate_and_adjust ./school/replace/incoming ./school/replace/actual
    local actual=$(cat ./school/replace/actual/variable)
...
function test_replace_is_strict_with_regex_matching {
    seed_incoming ./school/replace/incoming
    duplicate_and_adjust ./school/replace/incoming ./school/replace/actual
    local actual=$(cat ./school/replace/actual/no)
